...
// Skill is one entry from skill://index.json (SEP-2640, experimental).
...
//
// Experimental: SEP-2640 is still a Draft; the index shape may change.
...
//
// Experimental: SEP-2640 is still a Draft; see ListSkills.
